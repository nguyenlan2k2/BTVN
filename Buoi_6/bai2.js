const users = [
  ...
  const newUser1 = { id: 5, name: "Huong", age:19, gender: "female", money: 1234};
  const newUser2 = { id: 6, name: "Lan", age: 20, gender: "male", money: 5678};
...
function convertGender(users){
  ...
  richAndPoor(users);
  convertGender(users);
  updateUser(6,'Lan',19,'female',2345);
  show(users);